...
//删除赠品
buyGiftEvent.deleteGift = function(dom){
	$(dom).parent().parent().remove();
}

//删除促销商品
buyGiftEvent.deleteProduct = function(dom){
...
<div class="box-positon">
	<div class="rpos">当前位置: 促销活动管理 - 新增买赠活动</div>
	<div class="ropt"></div>
	<div class="clear"></div>
</div>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%" class="pn-ftable" style="font-size:13px;">
	<tr>
		...
		<td width="88%" class="pn-fcontent">
			<input type="radio" id="eventType1" onclick="commonEvent.toAddEventView(1);" checked="checked"><label for="eventType1">买赠</label>
...
<div style="text-align:center; margin-top:10px; margin-bottom: 20px;">
	<input type="button" class="submit" value="保存" onclick="buyGiftEvent.saveOrSubmit(1);" />&nbsp;&nbsp;
