...
//删除换购活动
swapBuyEvent.deleteSwapBuyEvent = function(dom){
	$(dom).parent().parent().remove();
}
...
//删除换购商品
swapBuyEvent.deleteGift = function(dom){
	$(dom).parent().parent().remove();
}
...
<div class="box-positon">
	<div class="rpos">当前位置: 促销活动管理 - 新增换购活动</div>
	<div class="ropt"></div>
	<div class="clear"></div>
</div>
	...
	<table cellspacing="1" cellpadding="2" border="0" width="100%" class="pn-ftable" style="font-size:13px;">
		<tr>
			...
			<td width="88%" class="pn-fcontent">
				...
				<input type="radio" id="eventType2" onclick="commonEvent.toAddEventView(2);" checked="checked"><label for="eventType2">换购</label>
		...
		<td class="pn-fcontent">
			<table id="productListTable" width="100%" class="pn-ftable" cellspacing="1">
				...
				<tr align="center" name="swap">
					...
					<td class="pn-fcontent">
						<input type="text" id="appendMoney" name="appendMoney" onchange="swapBuyEvent.countChange(this);" />
					</td>
					<td class="pn-fcontent">
			             <a href="javascript:;" style="color:blue;" onclick="swapBuyEvent.selectGift(this);">添加换购商品</a>
			             <table name="gift" width="100%"></table>
		            </td>
					<td class="pn-fcontent"><a href="javascript:;" onclick="swapBuyEvent.deleteSwapBuyEvent(this);">删除</a></td>
				</tr>
			</table>
...
<div style="text-align:center; margin-top:10px; margin-bottom: 20px;">
	<input type="button" class="submit" value="保存" onclick="swapBuyEvent.saveOrSubmit(1);" />&nbsp;&nbsp;
