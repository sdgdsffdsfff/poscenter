...
$(document).ready(function() {
	...
	SearchTree.tree.setXMLAutoLoading($('#initPath').val()+"/pos/resource!getChildrenXmlById.do");
	SearchTree.tree.loadXML($('#initPath').val()+"/pos/resource!getChildrenXmlById.do", function(){
		//只能选子节点
